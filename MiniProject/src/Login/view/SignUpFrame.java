...
public class SignUpFrame extends JFrame {
	...
	private JTextField securitynumber1;//앞자리
	private JTextField securitynumber2;//뒷자리
	...
	private void inSecurityNumberSignUp() {
		...
		securitynumber1 = new JTextField();
		securitynumber1.setBounds(200, 260, 70, 30);
		add(securitynumber1);

		securitynumber2 = new JTextField();
		securitynumber2.setBounds(300, 260, 70, 30);
		add(securitynumber2);
	}
