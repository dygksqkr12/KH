...
//				System.out.println(data);
	 ...
	 * https://
	 * docs.oracle.com
	 * :443 ----> 프로토콜에 대한 기본포트(서비스번호)는 생략가능 https-443, http-80, ftp-20....
	 * /javase/8/docs/api/java/util/AbstractList.html
	 * 
	...
	private void test2() {
		try {
//			URL url = new URL("https://docs.oracle.com/javase/8/docs/api/java/util/AbstractList.html");
